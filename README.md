...
2. ***kernel_size=3*** -этот параметр определяет размерность матрицы свёртки.
 ...
 качества увеличелись, но очень незначительно,в свою очередь значения графика потерь стали немного меньше. Это может свидетельствовать об незначительном, но улучшении обучения нейронной сети.
